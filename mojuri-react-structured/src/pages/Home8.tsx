...
<img alt="Image Slider" src="/media/slider/8-1.jpg"/>
</div>
<div class="item-info horizontal-center vertical-middle text-center">
<div class="content">
<h2 class="title-slider">Jewelry For Every Day</h2>
<a class="button-slider button button-outline border-black thick-border" href="/shop-grid-left">SHOP NOW</a>
</div>
</div>
</div>
</div>
...
<div class="item-content">
<div class="content-image">
<img alt="Image Slider" src="/media/slider/8-2.jpg"/>
</div>
<div class="item-info horizontal-center vertical-middle text-center">
<div class="content">
<h2 class="title-slider">Discover the Best of the Best</h2>
<a class="button-slider button button-outline border-black thick-border" href="/shop-grid-left">SHOP NOW</a>
</div>
</div>
</div>
...
<div class="item-content">
<div class="content-image">
<img alt="Image Slider" src="/media/slider/8-3.jpg"/>
</div>
<div class="item-info horizontal-center vertical-middle text-center">
<div class="content">
...
<!-- Block Product Categories (Layout 5) -->
<div class="block block-product-cats layout-5">
...
<img alt="Shop Rings" src="/media/product/cat-8-1.jpg"/>
</div>
</a>
...
<div class="row">
<div class="section-column full m-b-15">
<div class="item item-product-cat">
<div class="item-product-cat-content">
<a href="/shop-grid-left">
<div class="item-image animation-horizontal">
<img alt="Shop Bracelets" src="/media/product/cat-8-2.jpg"/>
</div>
</a>
<div class="product-cat-content-info">
<h2 class="item-title">
...
<div class="row">
<div class="section-column sm-m-b">
<div class="item item-product-cat">
<div class="item-product-cat-content">
<a href="/shop-grid-left">
<div class="item-image animation-horizontal">
<img alt="Shop Necklaces" src="/media/product/cat-8-3.jpg"/>
</div>
</a>
<div class="product-cat-content-info">
<h2 class="item-title">
...
<a href="/shop-grid-left">
<div class="item-image animation-horizontal">
<img alt="Shop Earrings" src="/media/product/cat-8-4.jpg"/>
</div>
</a>
<div class="product-cat-content-info">
<h2 class="item-title">
...
<img alt="Shop Charm" src="/media/product/cat-8-5.jpg"/>
</div>
</a>
<div class="product-cat-content-info">
<h2 class="item-title">
...
<div class="block-widget-wrap">
<div class="block-title"><h2>Everyday Elegance</h2></div>
<div class="block-content">
<div class="content-product-list slick-wrap">
<div class="slick-sliders products-list grid" data-columns="4" data-columns1="3" data-columns1440="4" data-columns2="3" data-columns3="2" data-columns4="1" data-dots="false" data-nav="1" data-slidestoscroll="true">
...
<section class="section section-padding background-img bg-img-6 p-t-70 p-b-50 m-b-70">
<div class="section-container small">
<!-- Block Intro (Layout 4) -->
<div class="block block-intro layout-4">
<div class="block-widget-wrap">
<ul class="nav nav-tabs">
<li class="nav-item">
<a class="nav-link active" data-toggle="tab" href="#beauty-ingenuity" role="tab">Beauty &amp; Ingenuity</a>
</li>
<li class="nav-item">
<a class="nav-link" data-toggle="tab" href="#ear-stack" role="tab">Ear Stack Magic</a>
</li>
<li class="nav-item">
<a class="nav-link" data-toggle="tab" href="#wristwear-essentials" role="tab">Wristwear Essentials</a>
</li>
</ul>
<div class="tab-content">
<div class="tab-pane fade show active" id="beauty-ingenuity" role="tabpanel">
<div class="row">
<div class="section-column left">
<div class="intro-wrap">
<h2 class="intro-title">Beauty &amp; Ingenuity</h2>
...
<div class="intro-btn">
<a class="button button-outline border-black thick-border animation-horizontal hover-opacity" href="/shop-grid-left">Shop Now</a>
</div>
</div>
</div>
<div class="section-column right">
<img alt="intro" class="animation-horizontal" height="414" src="/media/banner/intro-5.png" width="439"/>
</div>
</div>
</div>
<div class="tab-pane fade" id="ear-stack" role="tabpanel">
<div class="row">
<div class="section-column left">
<div class="intro-wrap">
<h2 class="intro-title">Ear Stack Magic</h2>
<div class="intro-item">
																	In faucibus efficitur nisi non egestas. Maecenas rutrum dui eu urna pellentesque porttitor. Phasellus ultricies facilisis viverra. Vivamus at urna felis. Etiam lacinia eleifend blandit. Sed tempor luctus turpis, ac laoreet velit sollicitudin non.
																</div>
<div class="intro-btn">
<a class="button button-outline border-black thick-border animation-horizontal hover-opacity" href="/shop-grid-left">Learn More</a>
</div>
</div>
</div>
<div class="section-column right">
...
<div class="tab-pane fade" id="wristwear-essentials" role="tabpanel">
<div class="row">
<div class="section-column left">
<div class="intro-wrap">
<h2 class="intro-title">Wristwear Essentials</h2>
<div class="intro-item">
																	Nunc interdum lacus sit amet orci. Vestibulum turpis sem, aliquet eget, lobortis pellentesque, rutrum eu, nisl. Phasellus magna. Vestibulum facilisis, purus nec pulvinar iaculis, ligula mi congue nunc, vitae euismod ligula urna in dolor. Cras sagittis.
																</div>
<div class="intro-btn">
...
<section class="section section-padding background-img bg-img-3 p-t-70 p-b-80 m-b-0">
<div class="section-container">
<!-- Block Testimonial -->
<div class="block block-testimonial layout-1">
<div class="block-widget-wrap">
<div class="testimonial-wrap slick-wrap">
<div class="slick-sliders" data-columns="1" data-columns1="1" data-columns2="1" data-columns3="1" data-columns4="1" data-dots="1" data-nav="0" data-slidestoscroll="true">
...
export default function Home8() {
  return <HtmlBlock html={pageHtml} className="mojuri-page mojuri-index8" />
}
